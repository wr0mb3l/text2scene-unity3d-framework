...
public class ActionBasedControllerManager : MonoBehaviour
{
    ...
    [SerializeField]
    [Tooltip("The reference to the action of canceling the Radial menu.")]
...
#pragma warning restore IDE0044
    ...
    void OnEnterRadialState(StateId previousStateId)
    {
        ...
        var menuProvider = m_BaseController.transform.GetComponentInChildren<RadialMenuController>();
    ...
    void OnUpdateSelectState()
    {
        ...
        {
            // Check if hit object has the right layer
            var layerMask = targets[0].interactionLayerMask;
            if (layerMask == (layerMask | (1 << LayerMask.NameToLayer("IsoSpaceEditable"))))
            {
