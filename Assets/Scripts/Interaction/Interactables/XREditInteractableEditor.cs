...
/// <summary>
/// Custom editor for an <see cref="XREditInteractable"/>.
/// </summary>
[CustomEditor(typeof(XREditInteractable), true), CanEditMultipleObjects]
public class XREditInteractableEditor : XRBaseInteractableEditor
{
    /// <summary><see cref="SerializedProperty"/> of the <see cref="SerializeField"/> backing <see cref="XREditInteractable.attachTransform"/>.</summary>
    protected SerializedProperty m_AttachTransform;
    /// <summary><see cref="SerializedProperty"/> of the <see cref="SerializeField"/> backing <see cref="XREditInteractable.attachEaseInTime"/>.</summary>
    protected SerializedProperty m_AttachEaseInTime;
    /// <summary><see cref="SerializedProperty"/> of the <see cref="SerializeField"/> backing <see cref="XREditInteractable.movementType"/>.</summary>
    protected SerializedProperty m_MovementType;
    /// <summary><see cref="SerializedProperty"/> of the <see cref="SerializeField"/> backing <see cref="XREditInteractable.velocityDamping"/>.</summary>
    protected SerializedProperty m_VelocityDamping;
    /// <summary><see cref="SerializedProperty"/> of the <see cref="SerializeField"/> backing <see cref="XREditInteractable.velocityScale"/>.</summary>
    protected SerializedProperty m_VelocityScale;
    /// <summary><see cref="SerializedProperty"/> of the <see cref="SerializeField"/> backing <see cref="XREditInteractable.angularVelocityDamping"/>.</summary>
    protected SerializedProperty m_AngularVelocityDamping;
    /// <summary><see cref="SerializedProperty"/> of the <see cref="SerializeField"/> backing <see cref="XREditInteractable.angularVelocityScale"/>.</summary>
    protected SerializedProperty m_AngularVelocityScale;
    /// <summary><see cref="SerializedProperty"/> of the <see cref="SerializeField"/> backing <see cref="XREditInteractable.trackPosition"/>.</summary>
    protected SerializedProperty m_TrackPosition;
    /// <summary><see cref="SerializedProperty"/> of the <see cref="SerializeField"/> backing <see cref="XREditInteractable.smoothPosition"/>.</summary>
    protected SerializedProperty m_SmoothPosition;
    /// <summary><see cref="SerializedProperty"/> of the <see cref="SerializeField"/> backing <see cref="XREditInteractable.smoothPositionAmount"/>.</summary>
    protected SerializedProperty m_SmoothPositionAmount;
    /// <summary><see cref="SerializedProperty"/> of the <see cref="SerializeField"/> backing <see cref="XREditInteractable.tightenPosition"/>.</summary>
    protected SerializedProperty m_TightenPosition;
    /// <summary><see cref="SerializedProperty"/> of the <see cref="SerializeField"/> backing <see cref="XREditInteractable.trackRotation"/>.</summary>
    protected SerializedProperty m_TrackRotation;
    /// <summary><see cref="SerializedProperty"/> of the <see cref="SerializeField"/> backing <see cref="XREditInteractable.smoothRotation"/>.</summary>
    protected SerializedProperty m_SmoothRotation;
    /// <summary><see cref="SerializedProperty"/> of the <see cref="SerializeField"/> backing <see cref="XREditInteractable.smoothRotationAmount"/>.</summary>
    protected SerializedProperty m_SmoothRotationAmount;
    /// <summary><see cref="SerializedProperty"/> of the <see cref="SerializeField"/> backing <see cref="XREditInteractable.tightenRotation"/>.</summary>
    protected SerializedProperty m_TightenRotation;
    /// <summary><see cref="SerializedProperty"/> of the <see cref="SerializeField"/> backing <see cref="XREditInteractable.trackScale"/>.</summary>
    protected SerializedProperty m_TrackScale;
    /// <summary><see cref="SerializedProperty"/> of the <see cref="SerializeField"/> backing <see cref="XREditInteractable.throwOnDetach"/>.</summary>
    protected SerializedProperty m_ThrowOnDetach;
    /// <summary><see cref="SerializedProperty"/> of the <see cref="SerializeField"/> backing <see cref="XREditInteractable.throwSmoothingDuration"/>.</summary>
    protected SerializedProperty m_ThrowSmoothingDuration;
    /// <summary><see cref="SerializedProperty"/> of the <see cref="SerializeField"/> backing <see cref="XREditInteractable.throwSmoothingCurve"/>.</summary>
    protected SerializedProperty m_ThrowSmoothingCurve;
    /// <summary><see cref="SerializedProperty"/> of the <see cref="SerializeField"/> backing <see cref="XREditInteractable.throwVelocityScale"/>.</summary>
    protected SerializedProperty m_ThrowVelocityScale;
    /// <summary><see cref="SerializedProperty"/> of the <see cref="SerializeField"/> backing <see cref="XREditInteractable.throwAngularVelocityScale"/>.</summary>
    protected SerializedProperty m_ThrowAngularVelocityScale;
    /// <summary><see cref="SerializedProperty"/> of the <see cref="SerializeField"/> backing <see cref="XREditInteractable.forceGravityOnDetach"/>.</summary>
    protected SerializedProperty m_ForceGravityOnDetach;
    /// <summary><see cref="SerializedProperty"/> of the <see cref="SerializeField"/> backing <see cref="XREditInteractable.retainTransformParent"/>.</summary>
    protected SerializedProperty m_RetainTransformParent;
    /// <summary><see cref="SerializedProperty"/> of the <see cref="SerializeField"/> backing <see cref="XREditInteractable.attachPointCompatibilityMode"/>.</summary>
    ...
    {
        /// <summary><see cref="GUIContent"/> for <see cref="XREditInteractable.attachTransform"/>.</summary>
        ...
        /// <summary><see cref="GUIContent"/> for <see cref="XREditInteractable.attachEaseInTime"/>.</summary>
        ...
        /// <summary><see cref="GUIContent"/> for <see cref="XREditInteractable.movementType"/>.</summary>
        ...
        /// <summary><see cref="GUIContent"/> for <see cref="XREditInteractable.velocityDamping"/>.</summary>
        ...
        /// <summary><see cref="GUIContent"/> for <see cref="XREditInteractable.velocityScale"/>.</summary>
        ...
        /// <summary><see cref="GUIContent"/> for <see cref="XREditInteractable.angularVelocityDamping"/>.</summary>
        ...
        /// <summary><see cref="GUIContent"/> for <see cref="XREditInteractable.angularVelocityScale"/>.</summary>
        ...
        /// <summary><see cref="GUIContent"/> for <see cref="XREditInteractable.trackPosition"/>.</summary>
        ...
        /// <summary><see cref="GUIContent"/> for <see cref="XREditInteractable.smoothPosition"/>.</summary>
        ...
        /// <summary><see cref="GUIContent"/> for <see cref="XREditInteractable.smoothPositionAmount"/>.</summary>
        ...
        /// <summary><see cref="GUIContent"/> for <see cref="XREditInteractable.tightenPosition"/>.</summary>
        ...
        /// <summary><see cref="GUIContent"/> for <see cref="XREditInteractable.trackRotation"/>.</summary>
        ...
        /// <summary><see cref="GUIContent"/> for <see cref="XREditInteractable.smoothRotation"/>.</summary>
        ...
        /// <summary><see cref="GUIContent"/> for <see cref="XREditInteractable.smoothRotationAmount"/>.</summary>
        ...
        /// <summary><see cref="GUIContent"/> for <see cref="XREditInteractable.tightenRotation"/>.</summary>
        ...
        /// <summary><see cref="GUIContent"/> for <see cref="XREditInteractable.throwOnDetach"/>.</summary>
        ...
        /// <summary><see cref="GUIContent"/> for <see cref="XREditInteractable.throwSmoothingDuration"/>.</summary>
        ...
        /// <summary><see cref="GUIContent"/> for <see cref="XREditInteractable.throwSmoothingCurve"/>.</summary>
        ...
        /// <summary><see cref="GUIContent"/> for <see cref="XREditInteractable.throwVelocityScale"/>.</summary>
        ...
        /// <summary><see cref="GUIContent"/> for <see cref="XREditInteractable.throwAngularVelocityScale"/>.</summary>
        ...
        /// <summary><see cref="GUIContent"/> for <see cref="XREditInteractable.forceGravityOnDetach"/>.</summary>
        ...
        /// <summary><see cref="GUIContent"/> for <see cref="XREditInteractable.retainTransformParent"/>.</summary>
        ...
        /// <summary><see cref="GUIContent"/> for <see cref="XREditInteractable.attachPointCompatibilityMode"/>.</summary>
        ...
        /// <summary>Array of type <see cref="GUIContent"/> for the options shown in the popup for <see cref="XREditInteractable.attachPointCompatibilityMode"/>.</summary>
