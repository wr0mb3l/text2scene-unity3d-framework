...
/// Heavily based on <see cref="ActionBasedController"/> and only adjusted to allow rotation and
/// switching between different Interaction states.
/// </summary>
/// <remarks>
...
public class EditController : XRBaseController
{
    ...
    [SerializeField]
    InputActionProperty m_SwitchInteractionModeAction;
    /// <summary>
    /// The Input System action to use for switching between Rotate/Scale/Move modes.
    /// Must be a <see cref="Vector2Control"/> Control. Will use the X-axis as the rotation input.
    /// </summary>
    public InputActionProperty switchInteractionModeAction
    {
        get => m_SwitchInteractionModeAction;
        set => SetInputActionProperty(ref m_SwitchInteractionModeAction, value);
    }

    [SerializeField]
    InputActionProperty m_InteractionAxisAction;
    /// <summary>
    /// The Input System action to use for moving/scaling/rotating the attach transform.
    /// Must be a <see cref="Vector2Control"/> Control. Will use the Y-axis as the translation input.
    /// </summary>
    public InputActionProperty interactionAxisAction
    {
        get => m_InteractionAxisAction;
        set => SetInputActionProperty(ref m_InteractionAxisAction, value);
    }
    ...
    void EnableAllDirectActions()
    {
        ...
        m_SwitchInteractionModeAction.EnableDirectAction();
        m_InteractionAxisAction.EnableDirectAction();
    }
    ...
    void DisableAllDirectActions()
    {
        ...
        m_SwitchInteractionModeAction.DisableDirectAction();
        m_InteractionAxisAction.DisableDirectAction();
    }
